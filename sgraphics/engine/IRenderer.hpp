...
namespace sg
{
    ...
    public:
        ...
        virtual void DrawRect(const FloatRectType &rect, const RgbType &rbg = {0, 0, 0, 255}, bool fill = false) = 0;
        ...
        virtual bool RenderCopy(ITexture::Ptr texture, const FloatRectType &src, const FloatRectType &dest) = 0;
